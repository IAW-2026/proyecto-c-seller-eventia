      ...
      <div className="mx-auto max-w-[860px] space-y-4 sm:space-y-5">
        <form className="space-y-4 sm:space-y-5" onSubmit={handleSubmit(onSubmit)}>
          ...
          <section className={SECTION}>
            ...
            <Field label="Nombre del Evento" error={errors.nombreEvento?.message}>
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5">
              <Field label="Fecha" error={errors.fecha?.message}>
                ...
                <Popover open={fechaOpen} onOpenChange={setFechaOpen}>
                  <PopoverTrigger className="flex h-12 w-full items-center gap-3 rounded-[16px] border border-[#ecd9c8] bg-[#fbf3e3] px-4 text-left text-[15px] transition focus:border-[#d7b9a3] focus:bg-[#fffaf0] focus:outline-none sm:h-14 sm:text-[16px]">
          ...
          <section className={SECTION}>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5">
              <Field label="Precio por Entrada" error={errors.precio?.message}>
              ...
              <Field label="Capacidad Total" error={errors.stock?.message}>
                <input
                  type="number"
                  placeholder="100"
                  className={INPUT}
              ...
              <Field label="Categoría" error={errors.categoria?.message}>
                ...
                >
                  <SelectTrigger className="!h-12 w-full rounded-[16px] border border-[#ecd9c8] bg-[#fbf3e3] px-4 text-[15px] text-[#5d4d45] transition focus:border-[#d7b9a3] focus:bg-[#fffaf0] sm:!h-14 sm:text-[16px]">
                    <SelectValue />
                  </SelectTrigger>
          ...
          <div className="flex justify-end border-t border-[#eadfd2] pt-4 sm:pt-5">
            <button
              ...
              className="h-11 w-full rounded-[16px] bg-[#7b0b0b] px-8 font-bold text-white shadow-[0_10px_20px_rgba(123,11,11,0.22)] transition hover:-translate-y-0.5 hover:bg-[#640808] active:translate-y-0 disabled:opacity-60 sm:w-auto"
            >
