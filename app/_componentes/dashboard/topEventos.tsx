        ...
        <div className="mt-4">
          {eventos.map((e, i) => (
            <div key={e.idEvento} className="flex items-center gap-3 border-b border-[#f0e8e0] py-3 last:border-b-0 last:pb-0">
              <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#f5e8e4] text-[10px] font-bold text-[var(--color-primary-vivid)]">
                {i + 1}
              </span>
              ...
              <div className="text-right shrink-0">
                <p className="text-[13px] font-semibold text-[var(--color-primary-vivid)]">${e.monto.toLocaleString()}</p>
