...
const COLORES = [
  { fill: 'var(--color-primary-vivid)', text: 'var(--color-primary-vivid)' },
  { fill: '#d4848a', text: '#d4848a' },
  { fill: '#e8a898', text: '#e8a898' },
  { fill: '#c0706a', text: '#c0706a' },
];

// Gráfico de barras que muestra el porcentaje de entradas vendidas por categoría
export default function CategoriaVentas({ categorias }: { categorias: CategoriaStats[] }) {
  return (
